...
object SampleData {
    fun makeItems(): List<ItemEntity> = listOf(
        ItemEntity(title = "Milk",           location = "Aisle 1",    cost = "$2.99",  description = "1 gallon whole milk",     storeId = 1),
        ItemEntity(title = "Bread",          location = "Bakery",     cost = "$1.99",  description = "Whole wheat loaf",          storeId = 2),
        ItemEntity(title = "Eggs",           location = "Aisle 2",    cost = "$3.49",  description = "Dozen large eggs",         storeId = 3),
        ItemEntity(title = "Cheese",         location = "Dairy",      cost = "$4.29",  description = "8 oz cheddar cheese",      storeId = 1),
